...
sde_dictionary['CS_RESTORED']['connection_file'] = r'C:\Users\smw\AppData\Roaming\ESRI\Desktop10.6\ArcCatalog\FEGEN2 cs2007_admin.sde'
...
sde_dictionary['WGEM']['connection_file'] = r'C:\Users\smw\AppData\Roaming\ESRI\Desktop10.6\ArcCatalog\TBB WGEMADMIN.sde'
...
bng_100km = r'C:\Users\smw\AppData\Roaming\ESRI\Desktop10.6\ArcCatalog\CEHCORP CORPADMIN.sde\CORPADMIN.BritishNationalGrid_100km'
print('\n\nbng_100km:\t\t{0}'.format(bng_100km))


# Define BritishNationalGrid_1km feature class
# bng_1km = r'C:\Users\SMW\AppData\Roaming\ESRI\Desktop10.1\ArcCatalog\Connection to LADB CEHCORP CORPADMIN.sde\CORPADMIN.BritishNationalGrid_100km'
bng_1km = r'C:\Users\smw\AppData\Roaming\ESRI\Desktop10.6\ArcCatalog\CEHCORP CORPADMIN.sde\CORPADMIN.BritishNationalGrid_1km'
print('\n\nbng_1km:\t\t{0}'.format(bng_1km))
...
cs_restored_blkdata = r'C:\Users\smw\AppData\Roaming\ESRI\Desktop10.6\ArcCatalog\FEGEN2 cs2007_admin.sde\CS2007_ADMIN.ForesterData\CS2007_ADMIN.BLKDATA'
print('\n\ncs_restored_blkdata:\t\t{0}'.format(cs_restored_blkdata))


# Define output coordinate system to be British National Grid (EPSG:27700)
print('\n\nDefining output coordinate system...')
arcpy.env.outputCoordinateSystem = arcpy.SpatialReference(27700)
print('\tfactoryCode:\t{0}'.format(arcpy.env.outputCoordinateSystem.factoryCode))
print('\tname:\t\t\t{0}'.format(arcpy.env.outputCoordinateSystem.name))
print('Defined output coordinate system.')
...
combined_fgdb = r'G:\CountrysideSurvey\cs2007-wgem-combined-schema\combined-schema-{0}.gdb'.format(datetime.datetime.now().strftime('%Y%m%d'))
...
restored_squares_csv = r'G:\CountrysideSurvey\cs2007-wgem-combined-schema\Sqs_CS_GMEP-from-clamw-20161107.csv'
...
# Define search_distance - used in the SelectLayerByLocation() tool
search_distance = 500.0 # metres
	...
	for sde in sde_dictionary.keys():
		...
		for dataset in sde_dictionary[sde]['datasets_to_copy']:
			...
			if sde == 'CS_RESTORED':
				...
				label = 'Welsh'
				intersect_fc = bng_1km  #bng_100km
				intersect_layer = 'fl_bng_1km'  #'fl_bng_100km'
				# where_clause = '{0} IN (\'SG\', \'SH\', \'SJ\', \'SM\', \'SN\', \'SO\', \'SR\', \'SS\', \'ST\')'.format(arcpy.AddFieldDelimiters(datasource=intersect_fc,
				#                                                                                                                                 field='OS_TILE'))
				where_clause = '{0} IN (\'SN0317\',\'SN0417\',\'SN0517\',\'SN0617\',\'SN0717\',\'SN0817\',\'SN0917\',\'SN1017\',\'SN1117\',\'SN1217\',\'SN1317\',\'SN0316\',\'SN0416\',\'SN0516\',\'SN0616\',\'SN0716\',\'SN0816\',\'SN0916\',\'SN1016\',\'SN1116\',\'SN1216\',\'SN1316\',\'SN0315\',\'SN0415\',\'SN0515\',\'SN0615\',\'SN0715\',\'SN0815\',\'SN0915\',\'SN1015\',\'SN1115\',\'SN1215\',\'SN1315\',\'SN0314\',\'SN0414\',\'SN0514\',\'SN0614\',\'SN0714\',\'SN0814\',\'SN0914\',\'SN1014\',\'SN1114\',\'SN1214\',\'SN1314\',\'SN0313\',\'SN0413\',\'SN0513\',\'SN0613\',\'SN0713\',\'SN0813\',\'SN0913\',\'SN1013\',\'SN1113\',\'SN1213\',\'SN1313\',\'SN0312\',\'SN0412\',\'SN0512\',\'SN0612\',\'SN0712\',\'SN0812\',\'SN0912\',\'SN1012\',\'SN1112\',\'SN1212\',\'SN1312\')'.format(arcpy.AddFieldDelimiters(datasource=intersect_fc,
				                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                field='OS_TILE'))
			else:
				sys.exit('\n\nPython script not coded for sde {0}\n\n'.format(sde))
			if dataset in ('BLKDATA', 'SCPTDATA', 'LINEARDATA', 'POINTDATA'):
				print('\t\t\tRemoving non-{0} data from feature class...'.format(label))
				...
				count = int(result.getOutput(0))
				print('\t\t\t\tintersect_layer count:\t\t{0}'.format(count))
				...
				count = int(result.getOutput(0))
				print('\t\t\t\tfeaturelayer count:\t\t{0}'.format(count))
				...
				count = int(result.getOutput(0))
				print('\t\t\t\tdataset_out count:\t\t{0}'.format(count))
				...
				print('\t\t\tRemoved non-{0} data from feature class.'.format(label))
			# Delete non-Summer 2016 Pilot squares from the CS_RESTORED tables or non-Welsh data from the WGEM tables
			if dataset in ('COMPDATA', 'EVENTDATA', 'SEVENTDATA', 'PCOMPDATA'):
				print('\t\t\tRemoving non-{0} data from table...'.format(label))
				result = arcpy.GetCount_management(in_rows=dataset_out)
				count = int(result.getOutput(0))
				print('\t\t\t\tdataset_out count:\t\t\t{0}'.format(count))
				tableview = 'tableview'
				parent_table = os.path.join(arcpy.env.workspace,
											data_dictionary[dataset]['parent_table'] + '_' + sde)
				...
				count = int(result.getOutput(0))
				print('\t\t\t\ttableview count:\t\t{0}'.format(count))
				...
				count = int(result.getOutput(0))
				print('\t\t\t\tdataset_out count:\t\t{0}'.format(count))
				print('\t\t\tRemoved non-{0} data from table.'.format(label))
			del label, intersect_fc, intersect_layer, where_clause
