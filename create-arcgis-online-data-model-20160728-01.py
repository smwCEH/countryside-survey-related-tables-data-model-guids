...
if copy_domains:
    ...
    #     print('\tAssigned domain to a field.')
    #
    # Add additional domain values to the CS2007_HABT_CODE domain
    print('\t#\n\tAdding additional domain values to CS2007_HABT_CODE domain...')
    ...
    for domain in domains:
        ...
        if domain.name == domain_name:
            ...
            if domain.domainType == 'CodedValue':
                ...
                print('\t\tMin:\t\t{0}'.format(domain.range[0]))
                print('\t\tMax:\t\t{0}'.format(domain.range[1]))
    print('\tAdded additional domain values to CS2007_HABT_CODE domain.')

    #
    # TODO: Add species to a domain???
